			...
			agreement: [
				{
					...
					texts: {
						...
						'sub_title': {
							'#cdata': 'Important Information for Minors'
						},
						'sub_text': {
							'@index': '1',
							'#cdata': 'Samtendo Network provides communication services, such as Wii U Chat. These services include features such as audio and video sharing. We have no control over the content that takes place inside such apps. Therefore, we are not responsible, nor can we be held liable, for anything that happens during use.'
						}
					},

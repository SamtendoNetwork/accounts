...
// Temporarily disabled: Miiverse must not block account cleanup or HTTP startup.
...
PNIDSchema.method('scrub', async function scrub() {
	...
	// Temporarily disabled: skip Miiverse cleanup until the service is configured.
	// try {
